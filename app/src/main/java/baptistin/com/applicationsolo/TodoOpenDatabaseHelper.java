...
import baptistin.com.applicationsolo.User;
...
public class TodoOpenDatabaseHelper extends OrmLiteSqliteOpenHelper{
    ...
    private Dao<Photos, Long> photoDao;
    ...
    public Dao<Photos, Long> getDaoPhotos() throws SQLException {
        if(photoDao == null) {
            photoDao = getDao(Photos.class);
        }
        return photoDao;
    }
}
